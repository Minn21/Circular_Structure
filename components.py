        ...
        dbc.Container(
            ...
            children=[
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        dbc.Label("Seismic Zone"),
                        dbc.Select(
                            id='seismic-zone',
                            options=[{'label': zone, 'value': zone} for zone in SEISMIC_ZONES.keys()],
                            value='Zone I',  # Default value
                            className='mb-2'
                        ),
                    ], width=12, md=6, lg=3),
                ], className='mb-3'),
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Label("Show Deformation"),
                        dbc.Switch(
                            id='deformation-toggle',
                            value=False,
                            className='mb-2'
                        ),
                    ], width=12, md=6, lg=3),
